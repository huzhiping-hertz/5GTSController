...
void RmtpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RmtpServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RmtpServer::*)(QString );
        ...
        {
            using _t = void (RmtpServer::*)(shared_ptr<RmtpCmdFixDFParam> );
...
QT_INIT_METAOBJECT const QMetaObject RmtpServer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_RmtpServer.data,
    qt_meta_data_RmtpServer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
